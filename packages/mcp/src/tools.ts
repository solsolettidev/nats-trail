...
export const mcpTools: McpToolDefinition[] = [
  ...
  tool(
    ...
    { contextId: { type: "string" }, key: { type: "string", description: "Name of a configured correlation key, e.g. trace_id." }, value: { type: "string" }, limit: limitProperty, fromTs: fromTsProperty, toTs: toTsProperty, maxScan: maxScanProperty },
    ["contextId", "key", "value", "limit"],
    SCAN_TIMEOUT_MS,
  ),
  tool(
  ...
  tool(
    ...
    { contextId: { type: "string" }, stream: { type: "string" }, sample: { type: "integer", minimum: 1, maximum: 100, description: "Messages to sample per subject (default 20)." }, limit: limitProperty, maxScan: maxScanProperty },
    ["contextId", "limit"],
    SCAN_TIMEOUT_MS,
  ),
